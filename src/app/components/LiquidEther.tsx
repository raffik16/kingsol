...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class ExternalForce extends ShaderPass {
      ...
      initForce(simProps: any) {
        ...
        const mouseM = new THREE.RawShaderMaterial({
          ...
          uniforms: { px: { value: simProps.cellScale }, force: { value: new THREE.Vector2(0,0) },
            center: { value: new THREE.Vector2(0,0) }, scale: { value: new THREE.Vector2(simProps.cursor_size, simProps.cursor_size) } }
        });
    ...
    class WebGLManager {
      props: any; output!: Output; autoDriver: AutoDriver; running = false;
    ...
    return () => {
      ...
      if (resizeObserverRef.current) try { resizeObserverRef.current.disconnect(); } catch (_) {}
      if (intersectionObserverRef.current) try { intersectionObserverRef.current.disconnect(); } catch (_) {}
