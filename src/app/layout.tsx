...
export const metadata: Metadata = {
  title: "King Sol & the Vibes | Cumbia. Soul. Fire.",
  description: "LA-based cumbia-infused indie rock & soul. Listen, shop merch, and catch us live.",
};
  ...
  return (
    <html lang="en">
      ...
      <body className="font-body bg-sol-dark text-gray-200 min-h-screen">
        ...
        {/* Footer */}
        <footer className="border-t border-sol-border bg-sol-dark">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div>
                <h3 className="font-display text-2xl font-bold text-white mb-4">KING SOL & THE VIBES</h3>
                <p className="text-gray-500 text-sm">Cumbia. Soul. Fire. Los Angeles, CA.</p>
              </div>
              <div>
                <h4 className="font-display text-sm uppercase tracking-wider text-gray-400 mb-4">Navigate</h4>
                <div className="space-y-2">
                  <Link href="/" className="block text-gray-500 hover:text-sol-gold text-sm transition-colors">Home</Link>
                  <Link href="/about" className="block text-gray-500 hover:text-sol-gold text-sm transition-colors">About</Link>
                  <Link href="/shop" className="block text-gray-500 hover:text-sol-gold text-sm transition-colors">Shop</Link>
                  <Link href="/contact" className="block text-gray-500 hover:text-sol-gold text-sm transition-colors">Contact</Link>
                </div>
              </div>
              <div>
                ...
                <div className="flex gap-4">
                  {/* Spotify */}
                  <a href="https://open.spotify.com/artist/4iYxgancLoKojQUwbWkIGT" target="_blank" rel="noopener" className="text-gray-500 hover:text-sol-gold transition-colors">
                  ...
                  {/* Instagram */}
                  <a href="https://www.instagram.com/king_vibes_official/" target="_blank" rel="noopener" className="text-gray-500 hover:text-sol-gold transition-colors">
