...
const shows = [
  { date: "APR 12", venue: "Rock & Roll Pizza Bar", city: "Reggae Sunday Residency", link: "#", highlight: true },
  { date: "APR 26", venue: "Malibu Music Second Saturdays", city: "Malibu, CA", link: "#" },
  { date: "MAY 10", venue: "The Regent Theater", city: "Los Angeles, CA", link: "#" },
  { date: "MAY 24", venue: "On the Boardwalk", city: "Venice Beach, CA", link: "#" },
];
    ...
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto pt-24">
          ...
          <p className="gradient-text font-accent text-2xl sm:text-3xl md:text-4xl font-semibold tracking-wider mb-8">
            Reggae. Cumbia. Soul. Fire.
          </p>

          {/* Spotify Player in Hero */}
          <div className="max-w-2xl mx-auto mb-8 spotify-embed">
            <iframe
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              target="_blank"
              rel="noopener"
              className="btn-rasta inline-flex items-center justify-center gap-2 bg-gradient-to-r from-rasta-gold to-sol-amber text-black font-display font-bold uppercase tracking-wider px-8 py-4 rounded-full hover:from-sol-amber hover:to-rasta-gold transition-all duration-300 animate-pulse-glow"
            >
            ...
            <Link
              href="/shop"
              className="btn-rasta inline-flex items-center justify-center gap-2 border-2 border-rasta-gold/50 text-rasta-gold font-display font-bold uppercase tracking-wider px-8 py-4 rounded-full hover:bg-rasta-gold/10 transition-all duration-300"
            >
              Shop Merch
            </Link>
          </div>
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <FadeIn>
          <h2 className="font-display text-3xl sm:text-4xl font-bold text-white uppercase tracking-tight mb-2">
            Top Tracks
          </h2>
        ...
        <div className="space-y-1">
          {tracks.map((track) => (
            <FadeIn key={track.num}>
              ...
              >
                <span className="track-badge">{track.num}</span>
                <div className="flex-1">
                  <span className="text-white group-hover:text-rasta-gold transition-colors font-medium">
                    {track.name}
                  </span>
                  {track.explicit && (
      ...
      <section className="max-w-4xl mx-auto px-4 py-16">
        <FadeIn>
          <div className="rasta-border-card rounded-2xl bg-sol-card p-8 sm:p-12 flex flex-col sm:flex-row gap-8 items-center card-lift">
            {/* Placeholder album art */}
            <div className="w-48 h-48 sm:w-56 sm:h-56 rounded-xl bg-gradient-to-br from-rasta-red/30 via-rasta-gold/20 to-rasta-green/30 flex-shrink-0 flex items-center justify-center">
              <svg className="w-16 h-16 text-rasta-gold/40" fill="currentColor" viewBox="0 0 24 24"><path d="M12 3v10.55c-.59-.34-1.27-.55-2-.55-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4V7h4V3h-6z"/></svg>
            </div>
            <div>
              <p className="text-rasta-green font-display text-sm uppercase tracking-widest mb-2">Latest Release</p>
              <h3 className="font-display text-3xl sm:text-4xl font-bold text-white mb-2">Plea To Humanity</h3>
              <p className="text-gray-400 mb-6">The fire of reggae meets the soul of cumbia — a plea for unity, love, and community from the streets of East LA.</p>
              <div className="flex gap-3">
                <a
                  href="https://open.spotify.com/artist/4iYxgancLoKojQUwbWkIGT"
                  target="_blank"
                  rel="noopener"
                  className="btn-rasta inline-flex items-center gap-2 bg-rasta-green text-white font-display text-sm font-semibold uppercase tracking-wider px-5 py-2.5 rounded-full hover:bg-rasta-green/80 transition-colors"
                >
                ...
                <a
                  href="#"
                  className="btn-rasta inline-flex items-center gap-2 bg-gradient-to-r from-[#FC3C44] to-[#FA2D48] text-white font-display text-sm font-semibold uppercase tracking-wider px-5 py-2.5 rounded-full hover:opacity-90 transition-opacity"
                >
                  Apple Music
                </a>
              </div>
        ...
        <div className="space-y-3">
          {shows.map((show) => (
            <FadeIn key={show.date + show.venue}>
              <div className={`bg-sol-card rounded-xl p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4 card-lift border ${
                show.highlight
                  ? "border-rasta-green/40 bg-gradient-to-r from-rasta-green/5 to-transparent"
                  : "border-sol-border hover:border-rasta-gold/30"
              } transition-all duration-300`}>
                <div className="font-display text-2xl font-bold text-rasta-gold w-24 flex-shrink-0">{show.date}</div>
                <div className="flex-1">
                ...
                <a
                  href={show.link}
                  className="btn-rasta font-display text-sm uppercase tracking-wider border border-rasta-gold/50 text-rasta-gold px-5 py-2 rounded-full hover:bg-rasta-gold hover:text-black transition-all duration-200 min-h-[44px] flex items-center"
                >
                  Tickets
                </a>
              </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-16">
        <FadeIn>
          <div className="flex items-center justify-between mb-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener"
              className="inline-flex items-center gap-2 text-rasta-gold font-display text-sm uppercase tracking-wider hover:text-rasta-red transition-colors"
            >
            ...
            <FadeIn key={i}>
              <div className="col-span-2 md:col-span-3">
                <iframe
                  ...
                  className="rounded-xl border-2 border-rasta-gold/20 bg-sol-card"
                  loading="lazy"
                />
              </div>
            </FadeIn>
        ...
        <div className="mt-6 text-center">
          <a
            ...
            target="_blank"
            rel="noopener"
            className="btn-rasta inline-flex items-center gap-2 bg-gradient-to-r from-rasta-red via-rasta-gold to-rasta-green text-white font-display font-bold uppercase tracking-wider px-8 py-3 rounded-full hover:opacity-90 transition-opacity"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
      ...
      <section className="border-t border-sol-border">
        <div className="max-w-4xl mx-auto px-4 py-16 text-center">
          <FadeIn>
            <h2 className="font-accent text-3xl text-rasta-gold uppercase tracking-tight mb-8">Follow the Vibes</h2>
            <div className="flex justify-center gap-6">
              <a href="https://open.spotify.com/artist/4iYxgancLoKojQUwbWkIGT" target="_blank" rel="noopener" className="text-gray-400 hover:text-rasta-green transition-all hover:scale-110 transform duration-200">
              ...
              <a href="https://www.instagram.com/king_vibes_official/" target="_blank" rel="noopener" className="text-gray-400 hover:text-rasta-red transition-all hover:scale-110 transform duration-200">
              ...
              <a href="https://www.instagram.com/king_vibes_official/" target="_blank" rel="noopener" className="text-gray-400 hover:text-rasta-gold transition-all hover:scale-110 transform duration-200">
              ...
              <a href="https://www.instagram.com/king_vibes_official/" target="_blank" rel="noopener" className="text-gray-400 hover:text-rasta-green transition-all hover:scale-110 transform duration-200">
